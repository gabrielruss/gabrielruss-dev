        ...
        <ul>
          ...
          <li>
            ...
            <ListItemContent>
              ...
              hard. As UX/UI, our job is made difficult by making our user's
              lives easier. That gives me purpose and I love it.
            </ListItemContent>
          </li>
          <li>
          ...
          <li>
            ...
            <ListItemContent>
              I personally like TypeScript a lot. I feel naked when I don't use
              it now. Other options are great as well such as Flow or using
              PropTypes for your React components.
            </ListItemContent>
          </li>
        </ul>
      </ImportantToMeWrapper>
